...
//  TFile* file1 = TFile::Open("/afs/cern.ch/work/p/ppalit/public/Data_MC/forgitpush/CMSSW_10_6_2/src/DQM/TrackingMonitorSource/Jobs/Run2017_UL/data/SingleMu/DQM_V0001_R000278509__Global__CMSSW_X_Y_Z__RECO.root");
  TFile* file1 = TFile::Open("/afs/cern.ch/work/p/ppalit/public/Data_MC/forgitpush/CMSSW_10_6_8_patch1/src/DQM/TrackingMonitorSource/Jobs/Run2016preVFP_UL/data/SingleMu/DQM_V0001_R000278509__Global__CMSSW_X_Y_Z__RECO.root");  
  file1->ls();  
//  TFile* file2 = TFile::Open("/afs/cern.ch/work/p/ppalit/public/Data_MC/forgitpush/CMSSW_10_6_2/src/DQM/TrackingMonitorSource/Jobs/Run2017_UL/data/ZtoMM/nopuroot/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root");
  TFile* file2 = TFile::Open("/afs/cern.ch/work/p/ppalit/public/Data_MC/forgitpush/CMSSW_10_6_8_patch1/src/DQM/TrackingMonitorSource/Jobs/Run2016preVFP_UL/data/ZtoMM/DQM_V0001_R000000001__Global__CMSSW_X_Y_Z__RECO.root");
  file2->ls(); 
 
  TH1F* h1 = dynamic_cast<TH1F*>(file1->Get("DQMData/Run 278509/StandaloneTrackMonitor/Run summary/highPurityTracks/nVertex"));	
//  TH1F* h1 = dynamic_cast<TH1F*>(file1->Get("DQMData/Run 278509/StandaloneTrackMonitor/Run summary/MuonTracks/nVertex"));
  ...
  //TH1F* h2 = dynamic_cast<TH1F*>(file2->Get("DQMData/Run 1/StandaloneTrackMonitor/Run summary/MuonTracks/nVertex"));
  ...
  TFile* f1 = TFile::Open("/afs/cern.ch/work/p/ppalit/public/Data_MC/forgitpush/CMSSW_10_6_8_patch1/src/DQM/TrackingMonitorSource/Jobs/Run2016preVFP_UL/data/ZtoMM/PileupScaleFactor_278509_wrt_nVertex_SingleMu_legacy_2016pre.root", "RECREATE");
  hn->Write();
  f1->Write();
  f1->Close();
