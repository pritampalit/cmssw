...
standaloneTrackMonitor = DQMEDAnalyzer('StandaloneTrackMonitor',
    ...
    #trackInputTag     = cms.untracked.InputTag('generalTracks'), # If selectedAlcaRecoZBTracks is not taken as input, i.e. alcareco selection not applied
    trackInputTag     = cms.untracked.InputTag('selectedAlcaRecoZBTracks'),                                   
