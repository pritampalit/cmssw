...
"file:/eos/user/p/ppalit3/Exotic/bstophiphignnsample/bstophiphi_gnn_total.root",
)
...
process.TFileService = cms.Service("TFileService", fileName = cms.string('bstophiphisignal.root'), closeFileFast = cms.untracked.bool(True))
...
if (L1TRKALGO == 'HYBRID'):
    ...
    process.pL1PhiMesonSelectionEmu = cms.Path(process.L1PhiMesonSelectionEmulationProducer)
    process.pL1BsMesonSelectionEmu = cms.Path(process.L1BsMesonSelectionEmulationProducer)
...
process.L1TrackNtuple = cms.EDAnalyzer('L1TrackObjectNtupleMaker',
        ...
        L1TrackSelectedInputTag = cms.InputTag("L1TrackSelectionProducer", "Level1TTTracksSelectedAssociated"),                                           # TTTracks, prompt, selected
        L1TrackSelectedEmulationInputTag = cms.InputTag("L1TrackSelectionProducer", "Level1TTTracksSelectedAssociatedEmulation"),                         # TTTracks, prompt, emulation, selected
        ...
        TrackPhiCandsEmulationInputTag = cms.InputTag("L1PhiMesonSelectionEmulationProducer", "Level1TTPhiMesonSelectedEmulation"),                               
        ...
        TrackBsCandsEmulationInputTag = cms.InputTag("L1BsMesonSelectionEmulationProducer", "Level1TTBsMesonSelectedEmulation"),                               
...
process.schedule = cms.Schedule(process.TTClusterStub, process.TTClusterStubTruth, process.dtc, process.TTTracksEmuWithTruth, process.pL1GTTInput, process.pPV, process.pPVemu, process.pL1TrackSelection, process.pL1KaonTrackSelection, process.pL1PhiMesonSelection, process.pL1PhiMesonSelectionEmu, process.pL1BsMesonSelection, process.pL1BsMesonSelectionEmu, process.pL1TrackJets, process.pL1TrackJetsEmu, process.pL1TrackFastJets, process.pTkMET, process.pTkMETEmu, process.pTkMHT, process.pTkMHTEmulator, process.ntuple)
